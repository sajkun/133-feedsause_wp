...
jQuery(document).ready(function(){
  if(location.hash == '#studio'){
    ...
    jQuery('.studio-link').addClass('active');
  }else{
...
Vue.component('single-studio-content', {
  ...
  computed:{
    ...
    /**
    * array of notes to display on page
    *
    * @return array of notes object
    */
    computed_studio_notes: function(){
      if('undefined' == typeof(this.order_data.messages) ) {
        return [];
      }
      var notes = this.order_data.messages.studio;
      var notes_c = [];
