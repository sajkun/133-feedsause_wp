...
<table class="credit-note-details">
    ...
    <tr style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>">
        <th class="column-product" style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>"><?php _e('Product', 'yith-woocommerce-pdf-invoice'); ?></th>
        ...
        <th class="column-refund-text" style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>"><?php _e('Description', 'yith-woocommerce-pdf-invoice'); ?></th>

        <?php if (ywpi_is_enabled_credit_note_subtotal_column($document)) : ?>
            <th class="column-amount" style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>"><?php _e('Subtotal', 'yith-woocommerce-pdf-invoice'); ?></th>
        <?php endif; ?>

        <?php if (ywpi_is_enabled_credit_note_total_tax_column($document)) : ?>
            <th class="column-amount" style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>"><?php _e('Total tax', 'yith-woocommerce-pdf-invoice'); ?></th>
        <?php endif; ?>

        <?php if ( ywpi_is_enabled_credit_note_total_shipping_column( $document ) ) : ?>
            <th class="column-amount" style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>"><?php _e( 'Shipping', 'yith-woocommerce-pdf-invoice' ); ?></th>
        <?php endif; ?>

        <?php if (ywpi_is_enabled_credit_note_total_column($document)) : ?>
            <th class="column-amount" style="background-color: <?php echo $table_header_color; ?>; color:<?php echo $table_header_font_color; ?>"><?php _e('Total', 'yith-woocommerce-pdf-invoice'); ?></th>
        <?php endif; ?>
    </tr>
    </thead>
    <tbody>
