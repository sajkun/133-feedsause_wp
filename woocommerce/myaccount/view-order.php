    ...
    <div class="summary">
      <div class="summary__header">
        ...
        <div class="summary__col valign-center text-right">
          <span class="summary__total"><?php echo wc_price($order->get_total()) ?></span>
  ...
  <?php endif ?>
	<div class="col-12 col-md-7">
     ...
     <div class="progress-wrapper">
  		 <ul class="progress-order progress" <?php echo wp_is_mobile() ? 'style="width: '.(count($orders) * 160). 'px; transform: translateX(-'.(($number_of_active -1)* 160).'px)"' : ''; ?> >
  		 <?php foreach ($orders as $key => $o):
  		 	?>

  		 	<li class="progress__item <?php echo $current_status_order >= $key && $current_status_meta? 'active' : ''  ?>">
  	 		 <span class="progress__item-dots"></span>
  	 		 <span class="progress__item-name"><?php echo $o['name']; ?></span>
  	 		</li>
