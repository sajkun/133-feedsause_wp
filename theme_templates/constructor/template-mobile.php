    ...
    <div class="summary-place"></div>
      ...
      *****************-->
      <div class="studio-content__page"   v-show="step == 2"  :key="'step-2'">
        ...
        <div class="spacer-h-20"></div>
        <h2 class="block-title">How many <span class="styled">photos</span> would you like?</h2>
          <div class="spacer-h-20"></div>
    ...
    <!-- **************
      ...
      *****************-->
      <div class="studio-content__page" v-show="step == 3"  :key="'step-3'">
        <div class="spacer-h-20"></div>
        <h2 class="block-title"><span class="styled">Customise</span> your product shoot</h2>
        <div class="spacer-h-20"></div>
        ...
        >
          ...
          <div  :key="'tab-3'"  class="studio-content__body" v-show="customize_step == 3">
            ...
            <div class="warning">
              Please check you’ve made all your customisations before continuing as you’ll be unable to make changes later
            </div>
    ...
    <!-- **************
      ...
      *****************-->
      <div class="studio-content__page" :key="'step-7'" v-show="step==7">
        <div class="spacer-h-20"></div>
        <h2 class="block-title"><span class="styled">Finalise</span> your shoot</h2>
        <div class="spacer-h-20"></div>
