...
>
  <div class="row no-gutters my-order" v-if="show">
    ...
    <div class="col-12" v-if="is_tablet">
    ...
    <div class="col-lg-5 clearfix padding-right-20" v-if="!is_tablet">
    ...
    <div class="col-12 col-lg-7" v-if="!is_tablet">
      <div class="progress-wrapper"  v-if="!is_tablet">
      ...
      <div class="spacer-h-45"   v-if="!is_tablet"></div>
      <h2 class="my-shoots__title mobile-hidden ">Gallery</h2>

      <p class="my-shoots__text"   v-if="!is_tablet">
    ...
    <div class="col-12"  v-if="is_tablet">
      ...
      <transition
        ...
        v-on:after-enter="enterAfter"
      >
        <div class="col-12"  v-if="mode=='photos'">
          <div class="spacer-h-15"></div>
